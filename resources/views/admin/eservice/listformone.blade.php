                                ...
                                <td>
                                    ...
                                    @if ($item->form_status === 'N')
                                        <button type="button" class="btn btn-success btn-sm btn-reply"
                                            ...
                                            data-id="{{ $item->form_id }}" data-form="{{ $id }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
            ...
            <div class="modal-content">
                <form id="replyForm" method="POST" action="{{ route('eservice.reply') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="form_table" id="modal-form-form">
                        <div class="mb-3">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.querySelectorAll('.btn-reply').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    const texteditorForm = this.dataset.form;
                    document.getElementById('modal-form-id').value = texteditorId;
                    document.getElementById('modal-form-form').value = texteditorForm;
                });
            });
        });
    </script>
