...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('/css/template/home.css') }}?v={{ filemtime(public_path('/css/template/home.css')) }}">
    <link rel="stylesheet" href="{{ asset('/css/template/book.css') }}">
    <link rel="stylesheet"
        href="{{ asset('/css/template/mobile.css') }}?v={{ filemtime(public_path('/css/template/mobile.css')) }}">
        ...
        <section class="box-menu">
            <nav class="nav-strip">
                ...
                <div class="nav-pill has-submenu">
                    บุคลากร
                    <div class="submenu">
                        <a href="/articles/menu/9">โครงสร้างองค์กร</a>
                        <a href="/personnel/menu/10">คณะผู้บริหาร</a>
                        <a href="/personnel/menu/11">สมาชิกสภา</a>
                        <a href="/personnel/menu/12">หัวหน้าส่วนราชการ</a>
                        <a href="/personnel/menu/13">สำนักปลัดเทศบาล</a>
                        <a href="/personnel/menu/14">กองคลัง</a>
                        <a href="/personnel/menu/15">กองช่าง</a>
                        <a href="/personnel/menu/16">กองการศึกษา</a>
                        <a href="/personnel/menu/17">หน่วยตรวจสอบภายใน</a>
                    </div>
                </div>
                <div class="nav-pill has-submenu">
                    ผลการดำเนินงาน
                    <div class="submenu">
                        <a href="/categories/menu/18">รายงานกองคลัง</a>
                        <a href="/categories/menu/19">รายงานผลการดำเนินงาน</a>
                        <a href="/categories/menu/20">รายงานการจัดซื้อจัดจ้างหรือการจัดหาพัสดุ</a>
                        <a href="/categories/menu/21">ข้อมูลเชิงสถิติ</a>
                        <a href="/categories/menu/22">การบริหารและพัฒนาทรัพยากรบุคล</a>
                        <a href="/categories/menu/23">มาตรการส่งเสริมความโปร่งใสและป้องกันการทุจริต</a>
                        <a href="/categories/menu/24">ประมวลจริยธรรม</a>
                        <a href="/categories/menu/25">นโยบายไม่รับของขวัญ</a>
                        <a href="/categories/menu/26">การเปิดโอกาสให้เกิดการมีส่วนร่วม</a>
                    </div>
                </div>
                  ...
                  <div class="nav-pill has-submenu">
                    อำนาจหน้าที่
                    <div class="submenu">
                        <a href="/articles/menu/27">เทศบาลตำบล</a>
                        <a href="/articles/menu/28">สำนักปลัดเทศบาล</a>
                        <a href="/articles/menu/29">กองคลัง</a>
                        <a href="/articles/menu/30">กองช่าง</a>
                        <a href="/articles/menu/31">กองการศึกษา</a>
                        <a href="/articles/menu/32">หน่วยตรวจสอบภายใน</a>
                    </div>
                </div>
        ...
        <section class="vistion-top">
            <div class="search-bar-container">
                ...
                <div class="search-button intercity-port">
                    <div class="scroll-text">บ้านเมืองน่าอยู่คู่เมืองหลวง ปวงประชามีคุณภาพ สภาพเศรษฐกิจยืนยง
                        มั่นคงรวมใจพัฒนา</div>
                </div>
